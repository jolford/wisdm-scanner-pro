...
const NewProject = () => {
  ...
  const [exportConfig, setExportConfig] = useState<Record<string, ExportConfig>>({
    csv: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    json: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    xml: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    txt: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    sql: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    access: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    oracle: { enabled: false, destination: '/exports/data/', convertFormat: 'none' },
    pdf: { enabled: false, destination: '/exports/documents/', convertFormat: 'none' },
    images: { enabled: false, destination: '/exports/images/', convertFormat: 'none' },
