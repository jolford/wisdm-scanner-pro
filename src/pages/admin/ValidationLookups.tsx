...
import { Loader2, Search, Settings, CheckCircle, Database } from 'lucide-react';
...
export default function ValidationLookups() {
  ...
  if (loading) {
    return (
      <AdminLayout title="Validation Lookups" description="Manage validation lookup configurations">
  ...
  return (
    <AdminLayout title="Validation Lookups" description="Manage validation lookup configurations for all projects">
                          ...
                          {config?.lookupFields && config.lookupFields.length > 0 && (
                            <div className="text-sm">
                              ...
                              <span className="text-muted-foreground">
                                {config.lookupFields.filter((f: any) => f.lookupEnabled).length} enabled
                              </span>
                            </div>
                          )}
                        </div>
