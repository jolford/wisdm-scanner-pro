  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        processing: "border-transparent bg-processing text-processing-foreground hover:bg-processing/80",
        ...
        "processing-soft": "border-processing/20 bg-processing-light text-processing",
      },
    },
    defaultVariants: {
      variant: "default",
