...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompts: Record<string, string> = {
      general: "You are a helpful AI assistant for WISDM Scanner Pro, a document scanning and validation system.",
      ...
      troubleshooting: "You are a technical support specialist for WISDM Scanner Pro. Help users troubleshoot scanning issues, OCR problems, export errors, and system configuration questions. Be clear, patient, and provide step-by-step guidance.",
